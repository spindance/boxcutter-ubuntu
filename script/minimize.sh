...
: ${PURGE_BUILD_ESSENTIAL:=yes}
if [[ $PURGE_BUILD_ESSENTIAL  =~ true || $PURGE_BUILD_ESSENTIAL =~ 1 || $PURGE_BUILD_ESSENTIAL =~ yes ]]; then
...
: ${PURGE_X11:=yes}
if [[ $PURGE_X11  =~ true || $PURGE_X11 =~ 1 || $PURGE_X11 =~ yes ]]; then
